...
namespace GeophiresLibrary.Repository
{
    public class SubsurfaceTechnicalRepository : ISubsurfaceTechnicalRepository
    {
        ...
        public SubsurfaceTechnicalRepository(ILogger<SubsurfaceTechnicalParameters> logger)
        {
            _logger = logger;
        }
        ...
        public async Task<SubsurfaceTechnicalParameters> GetSubsurfaceTechnicalParameters(string[] _content, SimulationParameters simulationParms)
        {
            ...
            {
                resvoloption = 3;
                _logger.LogWarning("Warning: If user-selected reservoir model is 1 or 2, then user-selected reservoir volume option cannot be 4 but should  be 1, 2, or 3. GEOPHIRES will assume reservoir volume option 3.");
            }
