...
namespace GeophiresSharp.Repository
{
    public class CapitalAndOMCostRepository : ICapitalAndOMCostRepository
    {
        ...
        public CapitalAndOMCostRepository(string[] content)
        {
            _content = content;
        }

        public async Task<CapitalAndOMCostParameters> GetCapitalAndOMCostParameters(SimulationParameters simulationParms)
        {
            ...
            {
                Console.WriteLine("Warning: Provided well drilling and completion cost adjustment factor not considered because valid total well drilling and completion cost provided.");
            }
            else if (ccwellfixedprovided == 0 && ccwelladjfactorprovided == 0)
            {
                ccwelladjfactor = 1;
                Console.WriteLine("Warning: No valid well drilling and completion total cost or adjustment factor provided. GEOPHIRES will assume default built-in well drilling and completion cost correlation with adjustment factor = 1.");
            }
            else if (ccwellfixedprovided == 1 && ccwellfixedvalid == 0)
            {
                Console.WriteLine("Provided well drilling and completion cost outside of range 0-1000. GEOPHIRES will assume default built-in well drilling and completion cost correlation with adjustment factor = 1.");
                ccwelladjfactor = 1;
            }
            else if (ccwellfixedprovided == 0 && ccwelladjfactorprovided == 1 && ccwelladjfactorvalid == 0)
            {
                Console.WriteLine("Provided well drilling and completion cost adjustment factor outside of range 0-10. GEOPHIRES will assume default built-in well drilling and completion cost correlation with adjustment factor = 1.");
                ccwelladjfactor = 1;
            }
            ...
            {
                Console.WriteLine("Warning: Provided reservoir stimulation cost adjustment factor not considered because valid total reservoir stimulation cost provided.");
            }
            else if (ccstimfixedprovided == 0 && ccstimadjfactorprovided == 0)
            {
                ccstimadjfactor = 1;
                Console.WriteLine("Warning: No valid reservoir stimulation total cost or adjustment factor provided. GEOPHIRES will assume default built-in reservoir stimulation cost correlation with adjustment factor = 1.");
            }
            else if (ccstimfixedprovided == 1 && ccstimfixedvalid == 0)
            {
                Console.WriteLine("Provided reservoir stimulation cost outside of range 0-100. GEOPHIRES will assume default built-in reservoir stimulation cost correlation with adjustment factor = 1.");
                ccstimadjfactor = 1;
            }
            else if (ccstimfixedprovided == 0 && ccstimadjfactorprovided == 1 && ccstimadjfactorvalid == 0)
            {
                Console.WriteLine("Provided reservoir stimulation cost adjustment factor outside of range 0-10. GEOPHIRES will assume default reservoir stimulation cost correlation with adjustment factor = 1.");
                ccstimadjfactor = 1;
            }
            ...
            if (totalcapcostvalid == 1)
            {
                if (ccplantfixedprovided == 1)
                    Console.WriteLine("Warning: Provided surface plant cost not considered because valid total capital cost provided.");
                if (ccplantadjfactorprovided == 1)
                    Console.WriteLine("Warning: Provided surface plant cost adjustment factor not considered because valid total capital cost provided.");
            }
            else
            {
                if (ccplantfixedvalid == 1 && ccplantadjfactorvalid == 1)
                    Console.WriteLine("Warning: Provided surface plant cost adjustment factor not considered because valid total surface plant cost provided.");
                else if (ccplantfixedprovided == 0 && ccplantadjfactorprovided == 0)
                {
                    ccplantadjfactor = 1;
                    Console.WriteLine("Warning: No valid surface plant total cost or adjustment factor provided. GEOPHIRES will assume default built-in surface plant cost correlation with adjustment factor = 1.");
                }
                else if (ccplantfixedprovided == 1 && ccplantfixedvalid == 0)
                {
                    Console.WriteLine("Provided surface plant cost outside of range 0-1000. GEOPHIRES will assume default built-in surface plant cost correlation with adjustment factor = 1.");
                    ccplantadjfactor = 1;
                }
                else if (ccplantfixedprovided == 0 && ccplantadjfactorprovided == 1 && ccplantadjfactorvalid == 0)
                {
                    Console.WriteLine("Provided surface plant cost adjustment factor outside of range 0-10. GEOPHIRES will assume default surface plant cost correlation with adjustment factor = 1.");
                    ccplantadjfactor = 1;
                }
            }
            ...
            if (totalcapcostvalid == 1)
            {
                if (ccgathfixedprovided == 1)
                    Console.WriteLine("Warning: Provided field gathering system cost not considered because valid total capital cost provided.");
                if (ccgathadjfactorprovided == 1)
                    Console.WriteLine("Warning: Provided field gathering system cost adjustment factor not considered because valid total capital cost provided.");
            }
            else
            {
                if (ccgathfixedvalid == 1 && ccgathadjfactorvalid == 1)
                {
                    Console.WriteLine("Warning: Provided field gathering system cost adjustment factor not considered because valid total field gathering system cost provided.");
                }
                else if (ccgathfixedprovided == 0 && ccgathadjfactorprovided == 0)
                {
                    ccgathadjfactor = 1;
                    Console.WriteLine("Warning: No valid field gathering system total cost or adjustment factor provided. GEOPHIRES will assume default built-in field gathering system cost correlation with adjustment factor = 1.");
                }
                else if (ccgathfixedprovided == 1 && ccgathfixedvalid == 0)
                {
                    Console.WriteLine("Provided field gathering system cost outside of range 0-100. GEOPHIRES will assume default built-in field gathering system cost correlation with adjustment factor = 1.");
                    ccgathadjfactor = 1;
                }
                else if (ccgathfixedprovided == 0 && ccgathadjfactorprovided == 1 && ccgathadjfactorvalid == 0)
                {
                    Console.WriteLine("Provided field gathering system cost adjustment factor outside of range 0-10. GEOPHIRES will assume default field gathering system cost correlation with adjustment factor = 1.");
                    ccgathadjfactor = 1;
                }
            }
            ...
            if (totalcapcostvalid == 1)
            {
                if (ccexplfixedprovided == 1)
                    Console.WriteLine("Warning: Provided exploration cost not considered because valid total capital cost provided.");
                if (ccexpladjfactorprovided == 1)
                    Console.WriteLine("Warning: Provided exploration cost adjustment factor not considered because valid total capital cost provided.");
            }
            else
            {
                if (ccexplfixedvalid == 1 && ccexpladjfactorvalid == 1)
                {
                    Console.WriteLine("Warning: Provided exploration cost adjustment factor not considered because valid total exploration cost provided.");
                }
                else if (ccexplfixedprovided == 0 && ccexpladjfactorprovided == 0)
                {
                    ccexpladjfactor = 1;
                    Console.WriteLine("Warning: No valid exploration total cost or adjustment factor provided. GEOPHIRES will assume default built-in exploration cost correlation with adjustment factor = 1.");
                }
                else if (ccexplfixedprovided == 1 && ccexplfixedvalid == 0)
                {
                    Console.WriteLine("Provided exploration cost outside of range 0-100. GEOPHIRES will assume default built-in exploration cost correlation with adjustment factor = 1.");
                    ccexpladjfactor = 1;
                }
                else if (ccexplfixedprovided == 0 && ccexpladjfactorprovided == 1 && ccexpladjfactorvalid == 0)
                {
                    Console.WriteLine("Provided exploration cost adjustment factor outside of range 0-10. GEOPHIRES will assume default exploration cost correlation with adjustment factor = 1.");
                    ccexpladjfactor = 1;
                }
            }
            ...
            if (oamtotalfixedvalid == 1)
            {
                if (oamwellfixedprovided == 1)
                    Console.WriteLine("Warning: Provided total wellfield O&M cost not considered because valid total annual O&M cost provided.");
                if (oamwelladjfactorprovided == 1)
                    Console.WriteLine("Warning: Provided wellfield O&M cost adjustment factor not considered because valid total annual O&M cost provided.");
            }
            else
            {
                if (oamwellfixedvalid == 1 && oamwelladjfactorvalid == 1)
                {
                    Console.WriteLine("Warning: Provided wellfield O&M cost adjustment factor not considered because valid total wellfield O&M cost provided.");
                }
                else if (oamwellfixedprovided == 0 && oamwelladjfactorprovided == 0)
                {
                    oamwelladjfactor = 1;
                    Console.WriteLine("Warning: No valid total wellfield O&M cost or adjustment factor provided. GEOPHIRES will assume default built-in wellfield O&M cost correlation with adjustment factor = 1.");
                }
                else if (oamwellfixedprovided == 1 && oamwellfixedvalid == 0)
                {
                    Console.WriteLine("Provided total wellfield O&M cost outside of range 0-100. GEOPHIRES will assume default built-in wellfield O&M cost correlation with adjustment factor = 1.");
                    oamwelladjfactor = 1;
                }
                else if (oamwellfixedprovided == 0 && oamwelladjfactorprovided == 1 && oamwelladjfactorvalid == 0)
                {
                    Console.WriteLine("Provided wellfield O&M cost adjustment factor outside of range 0-10. GEOPHIRES will assume default wellfield O&M cost correlation with adjustment factor = 1.");
                    oamwelladjfactor = 1;
                }
            }
            ...
            if (oamtotalfixedvalid == 1)
            {
                if (oamplantfixedprovided == 1)
                    Console.WriteLine("Warning: Provided total surface plant O&M cost not considered because valid total annual O&M cost provided.");
                if (oamplantadjfactorprovided == 1)
                    Console.WriteLine("Warning: Provided surface plant O&M cost adjustment factor not considered because valid total annual O&M cost provided.");
            }
            else
            {
                if (oamplantfixedvalid == 1 && oamplantadjfactorvalid == 1)
                {
                    Console.WriteLine("Warning: Provided surface plant O&M cost adjustment factor not considered because valid total surface plant O&M cost provided.");
                }
                else if (oamplantfixedprovided == 0 && oamplantadjfactorprovided == 0)
                {
                    oamplantadjfactor = 1;
                    Console.WriteLine("Warning: No valid surface plant O&M cost or adjustment factor provided. GEOPHIRES will assume default built-in surface plant O&M cost correlation with adjustment factor = 1.");
                }
                else if (oamplantfixedprovided == 1 && oamplantfixedvalid == 0)
                {
                    Console.WriteLine("Provided surface plant O&M cost outside of range 0-100. GEOPHIRES will assume default built-in surface plant O&M cost correlation with adjustment factor = 1.");
                    oamplantadjfactor = 1;
                }
                else if (oamplantfixedprovided == 0 && oamplantadjfactorprovided == 1 && oamplantadjfactorvalid == 0)
                {
                    Console.WriteLine("Provided surface plant O&M cost adjustment factor outside of range 0-10. GEOPHIRES will assume default surface plant O&M cost correlation with adjustment factor = 1.");
                    oamplantadjfactor = 1;
                }
            }
            ...
            if (oamtotalfixedvalid == 1)
            {
                if (oamwaterfixedprovided == 1)
                    Console.WriteLine("Warning: Provided total water cost not considered because valid total annual O&M cost provided.");
                if (oamwateradjfactorprovided == 1)
                    Console.WriteLine("Warning: Provided water cost adjustment factor not considered because valid total annual O&M cost provided.");
            }
            else
            {
                if (oamwaterfixedvalid == 1 && oamwateradjfactorvalid == 1)
                {
                    Console.WriteLine("Warning: Provided water cost adjustment factor not considered because valid total water cost provided.");
                }
                else if (oamwaterfixedprovided == 0 && oamwateradjfactorprovided == 0)
                {
                    oamwateradjfactor = 1;
                    Console.WriteLine("Warning: No valid total water cost or adjustment factor provided. GEOPHIRES will assume default built-in water cost correlation with adjustment factor = 1.");
                }
                else if (oamwaterfixedprovided == 1 && oamwaterfixedvalid == 0)
                {
                    Console.WriteLine("Provided total water cost outside of range 0-100. GEOPHIRES will assume default built-in water cost correlation with adjustment factor = 1.");
                    oamwateradjfactor = 1;
                }
                else if (oamwaterfixedprovided == 0 && oamwateradjfactorprovided == 1 && oamwateradjfactorvalid == 0)
                {
                    Console.WriteLine("Provided water cost adjustment factor outside of range 0-10. GEOPHIRES will assume default water cost correlation with adjustment factor = 1.");
                    oamwateradjfactor = 1;
                }
            }
