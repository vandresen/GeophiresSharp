...
namespace GeophiresSharp.Repository
{
    public class SimulationRepository : ISimulationRepository
    {
        ...
        public SimulationRepository(string[] content)
        {
            _content = content;
        }
        ...
        public async Task<SimulationParameters> GetSimulationParameters()
        {
            ...
            if (iTemp == null) Console.WriteLine($"Warning: No valid number of time steps per year provided. GEOPHIRES will assume default number of time steps per year (4)");
            ...
            {
                Console.WriteLine($"WWarning: No valid number of time steps per year provided. GEOPHIRES will assume default number of time steps per year (4)");
                simulationParms.timestepsperyear = 4;
            }
