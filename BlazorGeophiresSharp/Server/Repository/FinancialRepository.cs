...
namespace BlazorGeophiresSharp.Server.Repository
{
    public class FinancialRepository : IFinancialRepository
    {
        ...
        public FinancialRepository(string[] content, ILogger logger)
        {
            _content = content;
            _logger = logger;
        }

        public async Task<FinancialParameters> GetFinancialParameters(SimulationParameters simulationParms)
        {
